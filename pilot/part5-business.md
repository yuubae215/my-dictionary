...
**対象語彙（原辞書5章、45概念）の変換は本編をもって完了した。** （2026-09-02追補：メタ語彙14件も第M編として変換され、原辞書5章・6章の変換は完了した。未変換として残るのは全編化時に追加する附属書（MECE検証・索引類）のみである。D-2026-08-22-01（メタ語彙編の起こし方）は D-2026-08-22-19 で、D-2026-08-22-06（対比ペアの親概念）は D-2026-09-02-06 で決着した。）
